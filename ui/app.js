...
// hf7y/american-cycle#46: OPPONENT_BLURB above was measured against a fixed
// three-opponent field and #202 made a true 1-v-1 table reachable for the
// first time. findings/board-opponent-fitness.ts re-measured every agent
// head-to-head against Greedy (this repo's standing proxy for an ordinary
// player) and found the two do not agree: several agents that read as mild
// in a four-player game are near-unloseable or near-unwinnable 1v1. This
// blurb only renders when exactly one opponent is seated.
