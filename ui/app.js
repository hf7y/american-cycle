...
function setup() {
  ...
  modal(`
    ...
    <div class="row" style="margin-top:14px">
      ...
      <p class="note" style="max-width:46ch"><b>If this is your first game:</b> a seat is worth what it pays
      over its whole term, not what it scores today. Senate seats run six years and grant hand size;
      House seats are cheap but expire every cycle. Taking the highest-edge race each turn loses about
      94% of the time against a strong table.</p>
