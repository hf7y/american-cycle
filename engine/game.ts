...
export interface GameView {
  ...
  /** hf7y/american-cycle#37: the ticket was already tracked (`Game.
   *  vicePresident`, set in `presidentialRace`) but never handed to an
   *  agent -- the same class of gap #39 named a bug rather than an
   *  oversight to leave standing: a visible track agents cannot read. Who
   *  currently supplies the sitting president's running mate is public
   *  information at the table, so it belongs here. */
