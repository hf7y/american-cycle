...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-04T10:34:50Z',
  stampedOn: '3089e90',
  ...
  predicate(): Claim[] {
    ...
    return [
      ...
      { name: 'BillBlocker vs BillMaximizer duel, tuned', value: duelPct('BillBlocker', 'BillMaximizer', 'tuned.json', DUEL_N), stamped: 91.67, tolerance: 10, unit: '%' },
      ...
      { name: 'SenateFlood round-robin share, as-written-plus (extended field)', value: awp.SenateFlood, stamped: 16.67, tolerance: 8, unit: '%' },
    ];
  },
