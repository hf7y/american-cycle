...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-03T10:35:00Z',
  stampedOn: 'd512eb3',
  ...
  predicate(): Claim[] {
    ...
    return [
      { name: 'Vetoer vs BillMaximizer duel, tuned', value: duelPct('Vetoer', 'BillMaximizer', 'tuned.json', DUEL_N), stamped: 67.2, tolerance: 10, unit: '%' },
      { name: 'Vetoer vs BillMaximizer duel, as-written-plus', value: duelPct('Vetoer', 'BillMaximizer', 'as-written-plus.json', DUEL_N), stamped: 32.4, tolerance: 10, unit: '%' },
      { name: 'BillBlocker vs BillMaximizer duel, tuned', value: duelPct('BillBlocker', 'BillMaximizer', 'tuned.json', DUEL_N), stamped: 64.4, tolerance: 10, unit: '%' },
      { name: 'BillBlocker vs BillMaximizer duel, as-written-plus', value: duelPct('BillBlocker', 'BillMaximizer', 'as-written-plus.json', DUEL_N), stamped: 61.2, tolerance: 10, unit: '%' },
      { name: 'BillMaximizer round-robin share, tuned (extended field)', value: tuned.BillMaximizer, stamped: 2.8, tolerance: 6, unit: '%' },
      { name: 'BillMaximizer round-robin share, as-written-plus (extended field)', value: awp.BillMaximizer, stamped: 7.5, tolerance: 6, unit: '%' },
      { name: 'SenateFlood round-robin share, tuned (extended field)', value: tuned.SenateFlood, stamped: 35.5, tolerance: 8, unit: '%' },
      { name: 'SenateFlood round-robin share, as-written-plus (extended field)', value: awp.SenateFlood, stamped: 24.0, tolerance: 8, unit: '%' },
    ];
  },
