...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-05T04:41:25Z',
  stampedOn: '218542b',
  ...
  predicate(): Claim[] {
    ...
    return [
      ...
      { name: 'Vetoer vs BillMaximizer duel, as-written-plus', value: duelPct('Vetoer', 'BillMaximizer', 'as-written-plus.json', DUEL_N), stamped: 75, tolerance: 10, unit: '%' },
      ...
      { name: 'SenateFlood round-robin share, tuned (extended field)', value: tuned.SenateFlood, stamped: 50, tolerance: 8, unit: '%' },
