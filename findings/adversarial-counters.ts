...
export const finding: Finding = {
  ...
  predicate(): Claim[] {
    ...
    return [
      { name: 'Vetoer vs BillMaximizer duel, tuned', value: duelPct('Vetoer', 'BillMaximizer', 'tuned.json', DUEL_N), stamped: 75, tolerance: 10, unit: '%' },
      { name: 'Vetoer vs BillMaximizer duel, as-written-plus', value: duelPct('Vetoer', 'BillMaximizer', 'as-written-plus.json', DUEL_N), stamped: 50, tolerance: 10, unit: '%' },
      { name: 'BillBlocker vs BillMaximizer duel, tuned', value: duelPct('BillBlocker', 'BillMaximizer', 'tuned.json', DUEL_N), stamped: 83.33, tolerance: 10, unit: '%' },
      { name: 'BillBlocker vs BillMaximizer duel, as-written-plus', value: duelPct('BillBlocker', 'BillMaximizer', 'as-written-plus.json', DUEL_N), stamped: 75, tolerance: 10, unit: '%' },
      { name: 'BillMaximizer round-robin share, tuned (extended field)', value: tuned.BillMaximizer, stamped: 8.33, tolerance: 6, unit: '%' },
      { name: 'BillMaximizer round-robin share, as-written-plus (extended field)', value: awp.BillMaximizer, stamped: 16.67, tolerance: 6, unit: '%' },
      { name: 'SenateFlood round-robin share, tuned (extended field)', value: tuned.SenateFlood, stamped: 25, tolerance: 8, unit: '%' },
      { name: 'SenateFlood round-robin share, as-written-plus (extended field)', value: awp.SenateFlood, stamped: 0, tolerance: 8, unit: '%' },
    ];
  },
