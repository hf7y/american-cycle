...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-04T06:15:22Z',
  stampedOn: 'd0bd7ed',
  ...
  predicate(): Claim[] {
    ...
    return [
      { name: 'biennial 0/1/2: states realigned per game', value: biennial.fourPerGame, stamped: 10.48, tolerance: 2.0 },
      { name: 'biennial 0/1/2: states pinned at the cap', value: biennial.cappedPerGame, stamped: 2.58, tolerance: 2.0 },
      { name: 'annual 0/1/2: states realigned per game', value: annual.fourPerGame, stamped: 0.7, tolerance: 0.5 },
      { name: 'annual 2/3/4: states realigned per game', value: plus2.fourPerGame, stamped: 10.5, tolerance: 4.0 },
      { name: 'annual 2/3/4: states pinned at the cap', value: plus2.cappedPerGame, stamped: 0.18, tolerance: 0.5 },
      { name: 'annual 2/3/4: mean absolute lean', value: plus2.meanAbs, stamped: 1.77, tolerance: 0.7 },
      { name: 'biennial 0/1/2: mean absolute lean', value: biennial.meanAbs, stamped: 1.9, tolerance: 0.5 },
