...
export const finding: Finding = {
  ...
  predicate(): Claim[] {
    ...
    const on = run(base);
    return [
      { name: 'baseline: determination point', value: on.determination, stamped: 0.5, tolerance: 0.2, unit: 'fraction of game length' },
      { name: 'baseline: comeback rate', value: on.comeback, stamped: 0.25, tolerance: 0.03, unit: 'share of games' },
      ...
      { name: 'endorsements off: determination point', value: run(noEndorsements).determination, stamped: 0.38, tolerance: 0.2, unit: 'fraction of game length' },
      ...
      { name: 'hand bonuses off: determination point', value: run(noHandBonus).determination, stamped: 0.38, tolerance: 0.2, unit: 'fraction of game length' },
    ];
  },
