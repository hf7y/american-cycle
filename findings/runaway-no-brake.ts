...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-04T06:16:38Z',
  stampedOn: 'd0bd7ed',
  ...
  predicate(): Claim[] {
    ...
    return [
      ...
      { name: 'baseline: player-scores that never decrease', value: monotonicShare(cards, base), stamped: 0.06, tolerance: 0.02, unit: 'share of series' },
