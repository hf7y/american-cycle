...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-04T06:09:11Z',
  stampedOn: 'd0bd7ed',
  ...
  predicate(): Claim[] {
    ...
    return [
      { name: 'mixed table at 60%: bills pass', value: mixed.pass, stamped: 0.09, tolerance: 0.07, unit: 'share of attempts' },
      { name: 'one BillMaximizer at 60%: bills pass', value: willing.pass, stamped: 0.48, tolerance: 0.12, unit: 'share of attempts' },
      { name: 'four BillMaximizers at 60%: bills pass', value: allIn.pass, stamped: 1, tolerance: 0.06, unit: 'share of attempts' },
      { name: 'mixed table at 50%: bills pass', value: cloture50.pass, stamped: 0.22, tolerance: 0.1, unit: 'share of attempts' },
      { name: 'mixed table at 67%: bills pass', value: cloture67.pass, stamped: 0.01, tolerance: 0.06, unit: 'share of attempts' },
      { name: 'mixed table: cross-bench votes a game', value: mixed.cross, stamped: 100.99, tolerance: 18 },
      { name: 'four BillMaximizers: cross-bench votes a game', value: allIn.cross, stamped: 176.68, tolerance: 60 },
    ];
  },
