...
export const finding: Finding = {
  ...
  stampedAt: '2026-09-04T06:09:53Z',
  stampedOn: 'd0bd7ed',
  ...
  predicate(): Claim[] {
    ...
    return [
      { name: 'hand 8, districts 0.15', value: contested(8, 0.15), stamped: 38.37, tolerance: 3, unit: '%' },
      { name: 'hand 16, districts 0.15', value: contested(16, 0.15), stamped: 53.74, tolerance: 3, unit: '%' },
      { name: 'hand 24, districts 0.15', value: contested(24, 0.15), stamped: 65.8, tolerance: 3, unit: '%' },
      { name: 'hand 16, districts 0.06', value: contested(16, 0.06), stamped: 57.29, tolerance: 3, unit: '%' },
      { name: 'hand 16, districts 0.40', value: contested(16, 0.4), stamped: 44.65, tolerance: 3, unit: '%' },
      { name: 'hand 16, districts 1.00', value: contested(16, 1), stamped: 32.13, tolerance: 3, unit: '%' },
    ];
  },
